    ...
    g.prototype.init = function(b) {
        ...
        if (b) {
            ...
            a.each(b, function(b, e) {
                ...
                return f.append(d.options.enableLinks ? a(d.template.link).attr("href", e.href).append(e.name) : e.name+"<span style='float:right;'><a href='javascript:' onclick='return fnEdit("+e.id+");' title='Edit' class='btn btn-default' style='cursor:pointer; margin-top:-6px;'><i class='fa fa-edit'></i></a>&nbsp;<a href='javascript:' onclick='return fnDelete("+e.id+");' class='btn btn-default' title='Delete' style='cursor:pointer; margin-top:-6px;'><i class='fa fa-trash'></a></span>"), d.options.showTags && e.tags && a.each(e.tags, function(b, c) {
